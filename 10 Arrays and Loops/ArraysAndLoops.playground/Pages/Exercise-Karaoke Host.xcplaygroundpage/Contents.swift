 ...
 */
var song = [String]()
song .append("girls like you")
song .append("better now")
song .append("sicKo mode")
 ...
 */
song += ["girls like you","better now","sicKo mode"]
 ...
 */
let music = ["girls like you","better now","sicKo mode"]
for music in music
             {
    let star = "\(music)"
    print(" come on awesome 🥳 \(star) ")
}
