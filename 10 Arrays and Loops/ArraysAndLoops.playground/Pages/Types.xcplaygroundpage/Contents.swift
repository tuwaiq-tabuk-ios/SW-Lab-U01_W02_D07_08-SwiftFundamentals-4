...
*/
let someGrade = grades[0]    // The type is String
let someRating = starRatings[0] // The type is Int
...
print("______________EXERCISE_________________")
anotherGrade = starRatings[2]  /// I can not set
