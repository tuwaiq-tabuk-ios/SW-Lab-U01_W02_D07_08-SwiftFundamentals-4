...
*/
let milesBiked = [3, 7.5, 0, 0, 17, 2,3,4,5,6,12.2,7.1,12,3,4,5,2,8,2,6 ]
...
func goalMessage (dailyNumber: Double) -> String {
    if dailyNumber > goal*2 {
        return  "You walked \(dailyNumber) km today. Wow! You really exceeded your goal. Great stuff!"
...
for dailyKm in milesBiked {
        print(goalMessage(dailyNumber: dailyKm))
}
