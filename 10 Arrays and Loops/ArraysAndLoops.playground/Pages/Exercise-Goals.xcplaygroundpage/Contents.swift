 ...
 */
var milesBiked = [5.5, 12, 13.2, 0, 6.3,]
...
print("- - - Exercice1 - --")
let MilesBiked:[Double] = [2,4,7,7,9,23.6,1,4,3, 7.5,25,0,17,8.43,2,6,1,4,3, 7.5, 0]
MilesBiked.count
...
for number in milesBiked {
    print(dailyGoal(myGoal: number))
}
