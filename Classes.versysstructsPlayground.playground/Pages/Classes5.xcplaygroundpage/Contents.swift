...
let car1 = carClass5(licensePlate: "2211-JKL", brand: "Audi", model: "A1", color: "White")

print("car liceence plate:\(car1.licensePlate)")
print("car1 lights on :\(String(describing: car1.lightsOn))")
car1.start()

let car3 = carClass5(licensePlate: "7744-JKL", brand: "Audi", model: "A1", color: "Red",lightsOn: true)
