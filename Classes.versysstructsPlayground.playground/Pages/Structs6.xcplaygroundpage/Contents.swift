...
struct carStruct6 {
  ...
  let color: String
  var lightsOn: Bool?
  mutating   func turnlight (_ On:Bool){
    self.lightsOn = On
 }
...
let car2 = carStruct6(licensePlate: "6633-XYZ", brand: "BMW", model: "M1", color: "black")

print("car liceence plate:\(car2.licensePlate)")
print("car2 lights on :\(String(describing: car2.lightsOn))")
car2.start()

let car4 = carStruct6(licensePlate: "6556-XYZ", brand: "BMW", model: "M5", color: "red",lightsOn:true)

var car5 = car4
car5.lightsOn = false

car5.turnlight(false)
print("car5 lights on :\(String(describing: car4.lightsOn))")
